package com.femtoapp.expressterml.fragment.send;
...
import com.femtoapp.expressterml.adapter.get.AllOrdersRecyAdapter;
import com.femtoapp.expressterml.adapter.send.AllSendListRecyAdapter;
...
public class AllSendOrdersFragment extends BaseFragment {

    private static final String TAG = "AllSendOrdersFragment";
    private int type;
    private RelativeLayout empty;
    private RecyclerView rv_recyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private AllSendListRecyAdapter mAllSendListRecyAdapter;
    ...
    public static AllSendOrdersFragment newInstance(int type) {
        AllSendOrdersFragment fragment = new AllSendOrdersFragment();
                ...
                if (response.isSuccessful()) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mAllSendListRecyAdapter = new AllSendListRecyAdapter(mOrderList);
                            rv_recyclerView.setAdapter(mAllSendListRecyAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_all_send_list, container, false);
