...
public class AllOrdersFragment extends BaseFragment {
    ...
    private AllOrdersRecyAdapter mAllOrdersRecyAdapter;
    ...
    public static AllOrdersFragment newInstance(int type) {
    ...
    private void loadData() {
        ...
        Request request = new Request.Builder()
                .get()
                .url(api.LANSHOU + "?USER_ID=" + USER_ID)
                .build();
                ...
                if (response.isSuccessful()) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mAllOrdersRecyAdapter = new AllOrdersRecyAdapter(mOrderList);
                            rv_recyclerView.setAdapter(mAllOrdersRecyAdapter);
