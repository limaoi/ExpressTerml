...
import com.femtoapp.expressterml.adapter.send.AlreadySignAdapter;
...
public class AlreadySignFragment extends BaseFragment {
    ...
    private static final String TAG = "AlreadySignFragment";
    private int type;
    private RelativeLayout empty;
    private RecyclerView rv_recyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private AlreadySignAdapter mAlreadySignAdapter;
    ...
    public static AlreadySignFragment newInstance(int type) {
        AlreadySignFragment fragment = new AlreadySignFragment();
    ...
    private void loadData() {
        ...
        Request request = new Request.Builder()
                .get()
                .url(api.SEND + "?USER_ID=" + USER_ID + "&status=8")
                .build();
                ...
                if (response.isSuccessful()) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mAlreadySignAdapter = new AlreadySignAdapter(mOrderList);
                            rv_recyclerView.setAdapter(mAlreadySignAdapter);
