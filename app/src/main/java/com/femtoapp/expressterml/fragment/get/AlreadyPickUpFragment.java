...
import com.femtoapp.expressterml.adapter.get.AlreadyPuRecyAdapter;
...
public class AlreadyPickUpFragment extends BaseFragment {
    private static final String TAG = "AlreadyPickUpFragment";
    private int type;
    private RelativeLayout empty;
    private RecyclerView rv_recyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private AlreadyPuRecyAdapter mAlreadyPuRecyAdapter;
    ...
    public static AlreadyPickUpFragment newInstance(int type) {
        AlreadyPickUpFragment fragment = new AlreadyPickUpFragment();
    ...
    private void loadData() {
        ...
        Request request = new Request.Builder()
                .get()
                .url(api.LANSHOU + "?USER_ID=" + USER_ID + "&status=9")
                .build();
                ...
                if (response.isSuccessful()) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mAlreadyPuRecyAdapter = new AlreadyPuRecyAdapter(mOrderList);
                            rv_recyclerView.setAdapter(mAlreadyPuRecyAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_already_pu, container, false);
