...
import com.femtoapp.expressterml.adapter.send.NotSignAdapter;
...
public class NotSignFragment extends BaseFragment {

    private static final String TAG = "NotSignFragment";
    private int type;
    private RelativeLayout empty;
    private RecyclerView rv_recyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private NotSignAdapter mNotSignAdapter;
    ...
    public static NotSignFragment newInstance(int type) {
        NotSignFragment fragment = new NotSignFragment();
    ...
    private void loadData() {
        ...
        Request request = new Request.Builder()
                .get()
                .url(api.SEND + "?USER_ID=" + USER_ID + "&status=7")
                .build();
                ...
                if (response.isSuccessful()) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mNotSignAdapter = new NotSignAdapter(mOrderList);
                            rv_recyclerView.setAdapter(mNotSignAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_not_sign, container, false);
