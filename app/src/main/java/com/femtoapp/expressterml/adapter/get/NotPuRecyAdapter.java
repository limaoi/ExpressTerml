...
public class NotPuRecyAdapter extends RecyclerView.Adapter<NotPuRecyAdapter.ViewHolder> {

    private ArrayList<Order> mData;

    public NotPuRecyAdapter(ArrayList<Order> mData) {
        this.mData = mData;
    }
    ...
    @Override
    public NotPuRecyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_not_pu_item, parent, false);
        NotPuRecyAdapter.ViewHolder holder = new NotPuRecyAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(NotPuRecyAdapter.ViewHolder holder, int position) {
