...
public class AllSendListRecyAdapter extends RecyclerView.Adapter<AllSendListRecyAdapter.ViewHolder> {

    private ArrayList<Order> mData;

    public AllSendListRecyAdapter(ArrayList<Order> mData) {
        this.mData = mData;
    }
    ...
    @Override
    public AllSendListRecyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_all_send_list_item, parent, false);
        AllSendListRecyAdapter.ViewHolder holder = new AllSendListRecyAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(AllSendListRecyAdapter.ViewHolder holder, int position) {
