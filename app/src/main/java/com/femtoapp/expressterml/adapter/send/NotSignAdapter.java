...
public class NotSignAdapter extends RecyclerView.Adapter<NotSignAdapter.ViewHolder> {

    private ArrayList<Order> mData;

    public NotSignAdapter(ArrayList<Order> mData) {
        this.mData = mData;
    }
    ...
    @Override
    public NotSignAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_not_sign_item, parent, false);
        NotSignAdapter.ViewHolder holder = new NotSignAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(NotSignAdapter.ViewHolder holder, int position) {
